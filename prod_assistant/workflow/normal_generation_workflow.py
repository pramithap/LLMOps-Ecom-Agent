...
def invoke_chain(query: str, debug: bool = False):
    ...
    if debug: #Check if retreiever is working fine or not. False since we're passing "false" above
    ...
    response = chain.invoke(query) #Store result in response variable
...
if __name__=='__main__':
    user_query = "Can you suggest good budget iPhone under 5000 AUD?"
    retriever_obj = Retriever()
