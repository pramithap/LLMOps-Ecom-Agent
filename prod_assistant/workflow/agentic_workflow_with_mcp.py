...
class AgenticRAG:
    """Agentic RAG pipeline using LangGraph & MCP."""
    ...
    def __init__(self):
        ...
        self.mcp_client = MultiServerMCPClient({
            "product_retriever": {
                "command": "python",
                "args": ["/Users/2099070/Documents/Cognizant/LLMOps - Agents - Batch 1 /prod_assistant/mcp_servers/product_search_server.py"],  # absolute path recommended
                "transport": "stdio"
            }
        })
    ...
    def _grade_documents(self, state: AgentState) -> Literal["generator", "rewriter"]:
        ...
        docs = str(state["messages"][-1].content)
